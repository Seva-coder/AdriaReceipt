...
class SelectSuffixDialog : DialogFragment() {

    companion object {
        const val TAG = "SelectSuffixDialog"
        private const val KEY_POSITION = "POSITION"

        fun newInstance(position: Int): SelectSuffixDialog {
            val args = Bundle()
            args.putInt(KEY_POSITION, position)
            val fragment = SelectSuffixDialog()
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return activity?.let {
            ...
            val vm: ReceiptAddViewModel by activityViewModels {
